...
class OwnerFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'plate number' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'age' => 1,
                'plate number' => 'Lorem ipsum dolor sit a',
                'quantity' => 1
            ],
        ];
        parent::init();

...
class OwnersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'quatity' => ['type' => 'string', 'length' => 225, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'id_owners' => ['type' => 'integer', 'length' => 225, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'owners_fk0' => ['type' => 'index', 'columns' => ['id_owners'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'owners_fk0' => ['type' => 'foreign', 'columns' => ['id_owners'], 'references' => ['admin', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'quatity' => 'Lorem ipsum dolor sit amet',
                'id_owners' => 1
            ],
        ];
        parent::init();
